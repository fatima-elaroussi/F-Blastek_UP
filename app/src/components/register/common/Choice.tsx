    ...
    return (
        <div className="flex flex-col items-center pt-20">
            ...
            <div className="flex justify-center mt-6">
                <div className="relative flex flex-col mt-6 text-gray-700 bg-[#ebfbf0] shadow-md bg-clip-border rounded-xl w-96">
                ...
                <div className="relative flex flex-col mt-6 ml-6 text-gray-700 bg-[#ebfbf0] shadow-md bg-clip-border rounded-xl w-96">
                    <div className="flex flex-col items-center p-6">
